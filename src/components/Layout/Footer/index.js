...
import gg_play from '../../../assets/images/gg_play.png'
...
import pure_logo_2 from '../../../assets/images/pure_logo_2.png'
  ...
  return (
    ...
    <div className={styles.container_2}>
      ...
      <div className={styles.ctn_2_col}>
        {/* Cột 1 - Về PURE */}
        <div className={styles.div_logomedia}><img src={pure_logo_2} alt="Logo" /></div>
        <h3>VỀ PURÉ</h3>
        <ul>
          {["Về chúng tôi", "Sản phẩm", "Tuyển dụng", "Tư vấn", "Tin tức", "Điều khoản dịch vụ", "Liên hệ", "Chính sách thanh toán"].map((item) => (
            <li key={item}>{item}</li>
          ))}
        </ul>
      </div>
      ...
      <div className={styles.ctn_2_h25}></div>
        ...
        <div className={styles.ctn_2_downImg}>
          ...
          <div className={styles.ctn_2_divImg_appgg}>
            <img className={styles.img_appstore} src={appstore} alt="App Store" />
            <img className={styles.img_ggplay} src={gg_play} alt="Google Play" />
          </div>
        </div>
      </div>
      ...
      <div className={styles.ctn_2_col}>
        <div className={styles.div_logomedia}>
          ...
          <div className={styles.div_icon_fb_insta_yt} >
    ...
    <div className={styles.container_3}>
      <span className={styles.ctn_3_text_copyright}>© Copyright © 2025 Pure</span>
