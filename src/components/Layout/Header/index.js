        ...
        <div className={styles.div_ctn_2_right}>
          ...
          <div className={styles.container_bar_search}>
            <div className={styles.bar_search}>
              <div className={styles.div_icon_search}><img src={icon_search} alt='icon_search' /></div>
              <div className={styles.div_input_search}>
                <input type="text" placeholder="Voucher 15% - Đơn từ 99k | Deal Hot Dịp Hè" />
              </div>
            </div>
            <div className={styles.div_button}><div className={styles.button} ><img src={icon_user} alt='icon_user' /><span>Tài Khoản</span></div></div>
            <div className={styles.div_button}><div className={styles.button} ><img src={icon_cart} alt='icon_cart' /><span>Giỏ Hàng</span></div></div>
          </div>
        </div>
        {/*  */}
      </div>
