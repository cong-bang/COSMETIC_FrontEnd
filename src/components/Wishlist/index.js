...
import { addWishListToCart, deleteWishListById, get8WishList } from "../../services/wishListService";
    ...
    <div className={styles.wishlist}>
      ...
      <div className={styles.product_grid}>
        ...
        {wishList.map((item, index) => (
          <div key={index} className={styles.product_card}>
            <img src={item.productPlace.image || product_wishlist} alt={"Product"} />
            ...
            <div className={styles.actions}>
              <span onClick={(e) => { e.preventDefault(); handleAddItemToCart(); }}>Thêm vào giỏ hàng</span>
              <span onClick={(e) => { e.preventDefault(); handleRemoveItem(item.id); }}>
                Xóa
              </span>
            </div>
          </div>
