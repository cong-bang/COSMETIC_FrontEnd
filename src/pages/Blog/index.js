      ...
      <div className={styles.blogpage_container}>
        <div className={styles.section_intro}>
          ...
          <div className={styles.intro_content}>
            <h2 className={styles.intro_title}>
              Nature's Bounty – Kho Báu Thiên Nhiên: Nâng Tầm Sức Khỏe Và Vẻ Đẹp
              Tự Nhiên
            </h2>
            <p className={styles.intro_description}>
              “Nature's Bounty – Kho Báu Thiên Nhiên: Nâng Tầm Sức Khỏe Và Vẻ
              Đẹp Tự Nhiên” mở ra cánh cửa khám phá hành trình và triết lý đằng
              sau thương hiệu nổi tiếng này. Trong bối cảnh cuộc sống hiện đại
              đầy áp lực và ô nhiễm, nhu cầu tìm về thiên nhiên để cân bằng sức
              khỏe và duy trì vẻ đẹp trở nên cấp thiết.{" "}
            </p>
            <Link to="/blog-detail">
        ...
        <div className={styles.section_categories}>
          <Link
            ...
            style={{ backgroundImage: `url(${chamsocda})` }}
          >
          ...
          <Link
            to="/blog-category"
            className={styles.category_card}
            style={{ backgroundImage: `url(${chamsocsuckhoe})` }}
          >
          ...
          <Link
            to="/blog-category"
            className={styles.category_card}
            style={{ backgroundImage: `url(${xuhuonglamdep})` }}
          >
          ...
          <Link
            to="/blog-category"
            className={styles.category_card}
            style={{ backgroundImage: `url(${reviewsanpham})` }}
          >
        ...
        <div className={styles.section_lastest_posts}>
          <div className={styles.section_header}>
            ...
            <a href="#" className={styles.btn_seeall}>
              XEM TẤT CẢ
            </a>
          </div>
          ...
          <div className={styles.blog_fy_list}>
            <div className={styles.left_column}>
              <div
                ...
                style={{ backgroundImage: `url(${blog_fy1})` }}
              >
                <div className={styles.post_label}>
                  Mỹ phẩm hữu cơ là gì? Top 5 thương hiệu mỹ phẩm hữu cơ...
                </div>
              </div>
            </div>
            ...
            <div className={styles.wide_posts}>
              <div className={styles.wide_post}>
                ...
                <div className={styles.overlay_text}>
                  Làm Đẹp Toàn Diện: Hành Trình Chăm Sóc Da Hiệu Quả
                </div>
              </div>
              <div className={styles.wide_post}>
                <img src={blog_fy6} alt="Post Title" />
                <div className={styles.overlay_text}>
                  Xu Hướng Làm Đẹp 2025: Từ Skincare Đến Makeup Đột Phá
                </div>
              </div>
            </div>
          </div>
        ...
        <div className={styles.blog_grid}>
          ...
          <div className={styles.col_2}>
            <div className={styles.row}>
              <div className={styles.blog_item_small}>
                ...
                <div className={styles.overlay_text}>
                  Top 5 mã hồng tone lạnh...
                </div>
              </div>
              <div className={styles.blog_item_small}>
                <img src={blog_banqtam3} alt="" />
                <div className={styles.overlay_text}>
                  Bí Ẩn Sắc Đẹp Hàn Quốc: Xu Hướng Đang Lên Ngôi
                </div>
              </div>
            </div>
            <div className={styles.row}>
              <div className={styles.blog_item_small}>
                ...
                <div className={styles.overlay_text}>
                  Làm Đẹp Và Sức Khỏe: Mối Liên Hệ Không Thể Tách Rời
                </div>
              </div>
              <div className={styles.blog_item_small}>
                <img src={blog_banqtam5} alt="" />
                <div className={styles.overlay_text}>
                  Combo mỹ phẩm phù hợp...
                </div>
              </div>
            </div>
          </div>
          ...
          <div className={styles.col_3}>
            <div className={styles.blog_item_big}>
              ...
              <div className={styles.overlay_text}>
                Sắc Đẹp Tự Nhiên: Khám Phá Bí Ẩn Làn Da Không Tỳ Vết
              </div>
            </div>
          </div>
        </div>
